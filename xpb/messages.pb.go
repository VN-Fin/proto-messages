...
type BotSignalMessage struct {
	...
	Engine    string    `protobuf:"bytes,7,opt,name=engine,proto3" json:"engine,omitempty"`    // e.g., "AI-BOT", "TA-BOT", "MACD-BOT"
	Updated   int64     `protobuf:"varint,8,opt,name=updated,proto3" json:"updated,omitempty"` // Unix timestamp
}
...
func (x *BotSignalMessage) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_messages_proto_rawDesc = []byte{
	...
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0xdc, 0x01, 0x0a,
	...
	0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x6e, 0x67,
	...
	0x28, 0x03, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x42, 0x09, 0x5a, 0x07, 0x78,
	0x70, 0x62, 0x3b, 0x78, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
